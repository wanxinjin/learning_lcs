...
# load the learned
load_learned = np.load('learned_lcs_test2.npy', allow_pickle=True).item()
...
qp_learner = lcs_test.QPL_learner(n_state=n_state, n_control=n_control, n_lam=n_lam)
...
print('------------------------------------------------')
print(x_next_seg_batch[6:12].T)
print(pred_x_seg_batch[6:12].T)
