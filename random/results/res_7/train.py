...
# on the prediction using the current learned lcs
pred_x_next_batch, pred_lam_batch = learner.dyn_prediction(train_x_batch, curr_theta)
pred_dist_batch = learner.lcp_dist_fn(train_x_batch.T, pred_lam_batch.T, curr_theta).full()
pred_dist_batch = pred_dist_batch.T
...
np.save('learned', {
    ...
    'plot_y_index': plot_y_indx,
    'pred_lam_batch': pred_lam_batch,
    'pred_dist_batch': pred_dist_batch,
})
